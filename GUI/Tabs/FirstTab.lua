...
E.dungeonsForOptions = {"----------------Активности с переменным ilvl----------------",
						"На 3 рлк", "На 3 рбк", "Фул рбк", "Остров Кель'Данас", "ЭТГ",
						"Норигорн", "Фул охота", "6 Категория", "5 Категория",
						"4 Категория", "3 Категория", "2 Категория", "1 Категория",
						"----------------200-213 ilvl----------------", "Око вечности 10",
						"Око вечности 25", "Обсидиановое Святилище 10",
						"Обсидиановое Святилище 25", "Наксрамас 10",
						"Наксрамас 25", "----------------213-226 ilvl----------------", "ИК/Оня 10",
						"ИК/Оня 25", "ИВК 10", "ИВК 25", "Сa 10", "Сa 25",
						"----------------232-251 ilvl----------------", "Логово Магтеридона 25 об",
						"Логово Магтеридона 25 хм", "Логово Груула 25 об",
						"Логово Груула 25 хм", "Магик/Груул 25 об",
						"Магик/Груул 25 хм", "Каражан (репофарм)", "Каражан об",
						"Каражан хм", "Зул'Аман", "----------------251-275 ilvl----------------",
						"ТТГ 10", "ТТГ 25", "Цлк 10 об(репофарм)", "Цлк 10 об",
						"Цлк 25 об", "Цлк 10 хм", "Цлк 25 хм",
						"----------------276-290 ilvl----------------", "Змеиное Святилише 25 об",
						"Змеиное Святилише 25 хм", "Крепость бурь: Око 25 об",
						"Крепость бурь: Око 25 хм", "Рубиновое Святилище 10 об",
						"Рубиновое Святилище 10 хм",
						"Рубиновое Святилище 25 об",
						"Рубиновое Святилище 25 хм", "----------------297+ ilvl----------------",
						"Ульдуар 10 об", "Ульдуар 10 хм", "Ульдуар 25 об",
						"Ульдуар 25 хм", "Бронзовое Святилище 25 об",
						"Бронзовое Святилище 25 хм", "Хиджал (репофарм)",
						"Хиджал"}
E.dungeonsForSpam = {{"----------------Активности с переменным ilvl----------------"},
-- {"quest","67501:85","На 3 рлк"}, -- todo
					 {"journal", "0:283:2", "На 3 рлк"}, {"journal", "0:260:1", "На 3 рбк"},
					 {"journal", "0:260:1", "Фул рбк"},
					 {"journal", "0:777:1", "Остров Кель'Данас"}, {"journal", "0:777:1", "ЭТГ"},
					 {"journal", "1:11672:1", "Норигорн"}, {"journal", "0:747:2", "Фул охота 25"},
					 {"journal", "1:11666:1", "6 Категория"}, {"journal", "1:11667:1", "5 Категория"},
					 {"journal", "1:11668:1", "4 Категория"}, {"journal", "1:11669:1", "3 Категория"},
					 {"journal", "1:11670:1", "2 Категория"}, {"journal", "1:11671:1", "1 Категория"},
					 {"----------------200-213 ilvl----------------"},
					 ...
					 {"journal", "0:754:1", "Наксрамас 10"}, {"journal", "0:754:2", "Наксрамас 25"},
					 {"----------------213-226 ilvl----------------"}, {"journal", "0:757:1", "ИК/Оня 10"},
					 {"journal", "0:757:2", "ИК/Оня 25"}, {"journal", "0:757:3", "ИВК 10"},
					 {"journal", "0:757:4", "ИВК 25"}, {"journal", "0:753:1", "Сa 10"},
					 {"journal", "0:753:2", "Сa 25"}, {"----------------232-251 ilvl----------------"},
					 ...
					 {"journal", "0:745:1", "Каражан об"}, {"journal", "0:745:3", "Каражан хм"},
					 {"journal", "0:77:1", "Зул'Аман"}, {"----------------251-275 ilvl----------------"},
					 {"journal", "0:774:1", "ТТГ 10"}, {"journal", "0:774:2", "ТТГ 25"},
					 {"journal", "0:758:1", "Цлк 10 об(репофарм)"},
					 {"journal", "0:758:1", "Цлк 10 об"}, {"journal", "0:758:2", "Цлк 25 об"},
					 {"journal", "0:758:3", "Цлк 10 хм"}, {"journal", "0:758:4", "Цлк 25 хм"},
					 {"----------------276-290 ilvl----------------"},
					 ...
					 {"----------------297+ ilvl----------------"}, {"journal", "0:771:1", "Ульдуар 10 об"},
					 {"journal", "0:771:2", "Ульдуар 10 хм"}, {"journal", "0:771:3", "Ульдуар 25 об"},
					 {"journal", "0:771:4", "Ульдуар 25 хм"},
					 {"journal", "0:773:2", "Бронзовое Святилище 25 об"},
					 {"journal", "0:773:4", "Бронзовое Святилище 25 хм"},
					 {"journal", "0:778:2", "Хиджал (репофарм)"}, {"journal", "0:778:2", "Хиджал"}}
	...
	args = {
		...
		ChannelNumbers = {
			...
			get = function(info, key)
				return E.db.ChannelNumbers[key]
			end,
		...
		spamText = {
			...
			type = "description",
			name = function()
				return E.Core:GetLFGMsg() .. "\n" .. #E.Core:GetLFGMsg() .. "/255"
			end,
			width = "full"
		},
		spacer7 = {
		...
		startSpam = {
			...
			func = function()
				E.Core.IsNeedSendMessage = not E.Core.IsNeedSendMessage
			end
		}
	}
}
...
function E.GUI:CreateAssembleFrameRecord(i)
	E.GUI.CollapseFrame.MainFrame.AssembleFrame.ScrollParent.Records[i] =
		E.GUI.CollapseFrame.MainFrame.AssembleFrame.ScrollParent.Records[i] or
			CreateFrame("Button", nil, E.GUI.CollapseFrame.MainFrame.AssembleFrame.ScrollParent);
...
function E.GUI:CreateAssembleFrame()
	...
	local SortClassName = E.GUI:CreateSortButton(E.GUI.CollapseFrame.MainFrame.AssembleFrame, "SortClassName",
		E.Core.InvTable, "playerClassName", {"BOTTOMLEFT", ScrollParent, "TOPLEFT", 4.2 * self.recordHeight, 0}, true, nil)
	...
	local SortSpecName = E.GUI:CreateSortButton(E.GUI.CollapseFrame.MainFrame.AssembleFrame, "SortSpecName",
		E.Core.InvTable, "currentSpecName", {"BOTTOMLEFT", ScrollParent, "TOPLEFT", 8 * self.recordHeight, 0}, true, nil)
